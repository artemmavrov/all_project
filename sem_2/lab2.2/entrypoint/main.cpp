...
int main() {
    ...
    if (!read_csv("C:/Users/artem/Desktop/labs/algoritms/lab2.2/entrypoint/data_train.csv", allData)) {
        return 1;
    }

    if (!read_csv("C:/Users/artem/Desktop/labs/algoritms/lab2.2/entrypoint/dataset.csv", valData)) {
        return 1;
    }
